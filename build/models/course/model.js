...
const course_schema = new database_1.mongoose.Schema({
    ...
    reviews: [
        { type: database_1.mongoose.Schema.Types.ObjectId, ref: "Review", default: "" },
    ],
...
exports.Course = database_1.mongoose.model("Course", course_schema);
